...
<!-- Mirrored from demo.designshopify.com/html_jewelry/account.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Feb 2019 07:55:44 GMT -->
<!-- Added by HTTrack -->
                                        ...
                                        <ul id="customer_detail" class="list-unstyled sb-content">
                                            <li>
                                                <address class="clearfix">
                                                    ...
                                                    <div class="address">
                                                        <span class="address-group">
                                                            <span class="address1">Ung Van Khiem, Ho Chi Minh city,
                                                                Vietnam<span class="phone-number"></span></span>
                                                        </span>
                                                    </div>
                                                </address>
                                            </li>
                                            <li>
                                                <button class="btn btn-1" id="view_address" onclick="window.location='address.html'">Manager
                                                    Address (1)</button>
                                            </li>
                                        </ul>
                                    </div>

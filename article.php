...
<!-- Mirrored from demo.designshopify.com/html_jewelry/article.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Feb 2019 07:57:06 GMT -->
...
<head>
  ...
  <title>Article Full Width</title>
...
<body itemscope="" itemtype="http://schema.org/WebPage" class="templateArticle notouch">
					...
					<div itemprop="breadcrumb" class="container">
						<div class="row">
							<div class="col-md-24">
								...
								<span>/</span>
								<span class="page-title">Article Full Width</span>						
							</div>
						</div>
					</div>
				</div>                
					...
					<div class="container">
						<div class="row">
							<div id="page-header" class="col-md-24">
								<h1 id="page-title" class="large">Article Full Width</h1>
							</div>
										...
										<div class="row">
											<div class="article-content col-md-24">
												<div>
													...
													<h4 class="blog-title">vel illum qui dolorem eum fugiat</h4>
												</div>
												<div class="blogs-image">
													<ul class="list-inline">
														<li><img src="assets/images/banner_15eb5662-df95-4529-88ef-f2d53e90c572.png" alt=""></li>
													</ul>
												</div>
												<div class="intro">
													<p>
												...
												<form method="post" action="http://demo.designshopify.com/blogs/blogs/44831939-vel-illum-qui-dolorem-eum-fugiat/comments" id="article-44831939-comment-form" class="comment-form" accept-charset="UTF-8">

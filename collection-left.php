...
<!-- Mirrored from demo.designshopify.com/html_jewelry/collection-left.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Feb 2019 07:56:17 GMT -->
											...
											<ul id="sandBox" class="list-unstyled">
												...
												<li class="element first no_full_width" data-alpha="Gravida est quis euismod" data-price="20000">
													<ul class="row-container list-unstyled clearfix">
														...
														<div class="product-content-left">
															<a class="title-5" href="product.html">Gravida est quis euismod</a>
															<span class="spr-badge" id="spr_badge_12932310432" data-rating="0.0">
															<span class="spr-starrating spr-badge-starrating"><i class="spr-icon spr-icon-star-empty" style=""></i><i class="spr-icon spr-icon-star-empty" style=""></i><i class="spr-icon spr-icon-star-empty" style=""></i><i class="spr-icon spr-icon-star-empty" style=""></i><i class="spr-icon spr-icon-star-empty" style=""></i></span>
															<span class="spr-badge-caption">
															No reviews </span>
															</span>
												...
												<li class="element no_full_width" data-alpha="Malesuada fames ac ante" data-price="20000">
													<ul class="row-container list-unstyled clearfix">
														...
														<div class="product-content-left">
															<a class="title-5" href="product.html">Malesuada fames ac ante</a>
															<span class="spr-badge" id="spr_badge_12932292518" data-rating="0.0">
															<span class="spr-starrating spr-badge-starrating"><i class="spr-icon spr-icon-star-empty" style=""></i><i class="spr-icon spr-icon-star-empty" style=""></i><i class="spr-icon spr-icon-star-empty" style=""></i><i class="spr-icon spr-icon-star-empty" style=""></i><i class="spr-icon spr-icon-star-empty" style=""></i></span>
															<span class="spr-badge-caption">
															No reviews </span>
															</span>
												...
												<li class="element no_full_width" data-alpha="Maximus quam posuere" data-price="20000">
													<ul class="row-container list-unstyled clearfix">
														...
														<div class="product-content-left">
															<a class="title-5" href="product.html">Maximus quam posuere</a>
															<span class="spr-badge" id="spr_badge_12932269471" data-rating="0.0">
															<span class="spr-starrating spr-badge-starrating"><i class="spr-icon spr-icon-star-empty" style=""></i><i class="spr-icon spr-icon-star-empty" style=""></i><i class="spr-icon spr-icon-star-empty" style=""></i><i class="spr-icon spr-icon-star-empty" style=""></i><i class="spr-icon spr-icon-star-empty" style=""></i></span>
															<span class="spr-badge-caption">
															No reviews </span>
															</span>

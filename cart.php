...
<!-- Mirrored from demo.designshopify.com/html_jewelry/cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Feb 2019 07:57:06 GMT -->
									...
									<div class="row table-cart">
										<div class="wrap-table">
											...
											<tr class="item donec-condime-fermentum">
												...
												<td class="action">
													<button type="button" onclick="window.location='http://demo.designshopify.com/cart/change?line=1&amp;quantity=0'"><i class="fa fa-times"></i>Remove</button>
												</td>
											</tr>
											<tr class="item curabitur-cursus-dignis-1">
												<td class="title text-left">
													<ul class="list-inline">
														<li class="image">
														<a href="product.html">
														<img src="assets/images/2_119a31f2-2054-4483-93a3-841310e6bdfb_small.jpg" alt="Curabitur cursus dignis">
														</a>
														</li>
														<li class="link">
														<a href="product.html">
												...
												<td class="action">
													<button type="button" onclick="window.location='http://demo.designshopify.com/cart/change?line=2&amp;quantity=0'"><i class="fa fa-times"></i>Remove</button>
												</td>
											</tr>
											</tbody>
											<tfoot>
